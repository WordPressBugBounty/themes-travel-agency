...
function travel_agency_breadcrumb(){    
    ...
    if( travel_agency_is_elementor_activated_post() ) return false;
    ...
    <div id="content" class="site-content">
        <div class="container">
            ...
            */
            ...
            if( !travel_agency_is_elementor_activated_post() ){ ?>
...
function travel_agency_page_header(){
    if( ! travel_agency_is_elementor_activated_post() && ! is_page_template( array( 'templates/template-trip-listing.php' ) ) ){ ?>    
